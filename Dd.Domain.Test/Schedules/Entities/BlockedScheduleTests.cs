...
using Dd.Domain.Schedules.Enums;
...
public class BlockedScheduleTests {
    ...
    public void Constructor_ShouldInitializeProperties_WhenValidParametersAreProvided() {
        ...
        const BlockedScheduleType blockedTimeType = BlockedScheduleType.Vacation;
        ...
        Assert.Equal(blockedTimeType, blockedTime.BlockedScheduleType);
    ...
    public void BlocksAll_ShouldSetBlocksAllPhysiciansToTrue() {
        // Arrange
        var blockedTime = new BlockedSchedule(BlockedScheduleType.Vacation, _date610, new TimeOnly(9, 0), new TimeOnly(17, 0));
        // Act
    ...
    public void RecurWeekly_ShouldRemoveDuplicateDays_WhenCalledWithDuplicateDays() {
        ...
        var endTime = new TimeOnly(17, 0);
        var startDate = DateOnly.FromDateTime(DateTime.UtcNow.AddDays(1));
        var blockedTime = new BlockedSchedule(BlockedScheduleType.Vacation, startDate, startTime, endTime);
    ...
    public void UpdateRecurrenceInterval_ShouldUpdateInterval_WhenCalledWithValidInterval() {
        ...
        var startTime = new TimeOnly(9, 0);
        var endTime = new TimeOnly(17, 0);
        var blockedTime = new BlockedSchedule(BlockedScheduleType.AnnualLeave, _date610, startTime, endTime);
    ...
    public void UpdateRecurrenceInterval_ShouldThrowArgumentOutOfRangeException_WhenIntervalIsNotPositive() {
        ...
        var endTime = new TimeOnly(17, 0);
        var startDate = DateOnly.FromDateTime(DateTime.UtcNow.AddDays(1));
        var blockedTime = new BlockedSchedule(BlockedScheduleType.AnnualLeave, startDate, startTime, endTime);
    ...
    public void IsWholeDayBlocked_ShouldReturnFalse_WhenDateIsBeforeStartDate() {
        ...
        var startDate = DateOnly.FromDateTime(DateTime.UtcNow.AddDays(1));
        var endDate = DateOnly.FromDateTime(DateTime.UtcNow.AddDays(2));
        var blockedTime = new BlockedSchedule(BlockedScheduleType.Vacation, startDate, null, null, endDate);
        ...
        var startTime = new TimeOnly(9, 0);
        var endTime = new TimeOnly(17, 0);
        var blockedTimeWithTime = new BlockedSchedule(BlockedScheduleType.Vacation, startDate, startTime, endTime, endDate);
    ...
    public void IsWholeDayBlocked_ShouldReturnFalse_WhenStartTimeAndEndTimeAreSet() {
        ...
        var startTime = new TimeOnly(9, 0);
        var endTime = new TimeOnly(17, 0);
        var blockedTime = new BlockedSchedule(BlockedScheduleType.Vacation, startDate, startTime, endTime, endDate);
    ...
    public void IsWholeDayBlocked_ShouldReturnTrue_WhenDateIsEndDate() {
        ...
        var startDate = DateOnly.FromDateTime(DateTime.UtcNow.AddDays(1));
        var endDate = DateOnly.FromDateTime(DateTime.UtcNow.AddDays(2));
        var blockedTime = new BlockedSchedule(BlockedScheduleType.Vacation, startDate: startDate, null, null, endDate: endDate);
    ...
    public void IsWholeDayBlocked_ShouldReturnTrue_WhenStartAndEndDatesNotSpecified() {
        // Arrange
        var blockedTime = new BlockedSchedule(BlockedScheduleType.Vacation, _date610, null, null);
    ...
    public void IsWholeDayBlocked_WhenDailyRecurrence() {
        ...
        // Arrange
        var blockedTime = new BlockedSchedule(BlockedScheduleType.AnnualLeave, _date610, null, null);
        blockedTime.RecurDaily(2);
    ...
    public void IsWholeDayBlocked_WhenWeeklyRecurrence() {
        ...
        // Arrange
        var blockedTime = new BlockedSchedule(BlockedScheduleType.AnnualLeave, startDate: _date610, null, null);
    ...
    public void IsBlocked_ReturnsFalse_WhenDateIsBeforeStartDate() {
        ...
        var blocked = new BlockedSchedule(BlockedScheduleType.AnnualLeave, _date610, null, null, _date620);
    ...
    public void IsBlocked_ReturnsFalse_WhenTimeDoesNotOverlap() {
        ...
        var startTimeToCheck = new TimeOnly(8, 0);
        var endTimeToCheck = new TimeOnly(9, 0);
        var blocked = new BlockedSchedule(BlockedScheduleType.AnnualLeave, _date615, startTime, endTime, _date615);
    ...
    public void IsBlocked_ReturnsTrue_ForDailyRecurrence() {
        ...
        var blocked = new BlockedSchedule(BlockedScheduleType.AnnualLeave, _date610, startTime, endTime, _date620);
        Assert.True(blocked.IsBlocked(_date615, startTimeToCheck, endTimeToCheck));
    }
